...
const renderPptx = (pptx, resultElement, thumbElement) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    */
    ...
    resize();
    const containerDom = document.getElementById('ppt-container');
    // console.log('🚀 ~ returnnewPromise ~ containerDom:', containerDom);
    // containerDom?.addEventListener('resize', resize);
    ...
    containerDom && myObserver.observe(containerDom);
